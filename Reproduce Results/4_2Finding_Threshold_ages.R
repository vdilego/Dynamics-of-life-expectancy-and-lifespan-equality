...
#DT <-  Data[Data$PopName == 'ISL' & Data$Sex == 'f',]
#i <- 110
...
#try with datatable
#Data <- Data[Data$PopName == 'ISL' & Data$Sex == 'f' & Data$Year %in% c(1981,1982,1991,2016),]
strt<-Sys.time()
...
#Threshold.ages[a.h == 45 | a.g == 45 | a.v == 45,]
#Threshold.ages[a.h == -1 | a.g == -1 | a.v == -1,]
#Threshold.ages[PopName =='FRATNP' & Year %in% 1905:1914,]
