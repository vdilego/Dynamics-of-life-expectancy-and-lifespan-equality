...
# I need the percentage of deaths below the threshold age, mode and life expectancy
...
# a third graph with the percentage of the cganhe in life expectancy due to change in death rates below some ages
...
pdf(file="Figures/FigureBox.pdf",width=12,height=12,pointsize=4)
